...
class Pokemon:
    ...
    def calculate_dps(self, fast_move, charge_move, atk_stat, atk_iv):
        fm_power, fm_duration, fm_energy_gain, fm_type = (
            fast_move["power"],
            fast_move["duration"] / 1000,
            fast_move["energy_delta"],
            fast_move["type"].lower(),
        )
        cm_power, cm_duration, cm_energy_cost, cm_type = (
            charge_move["power"],
            charge_move["duration"] / 1000,
            charge_move["energy_delta"],
            charge_move["type"].lower(),
        )
